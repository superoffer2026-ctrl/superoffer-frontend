...
@Component({
  ...
  `,
  styles: [`
    .upload{min-height:116px;padding:18px;display:flex;align-items:center;gap:14px;border:1.5px dashed #d7cec5;border-radius:17px;background:#fdfbf8;cursor:pointer;transition:.22s}.upload:hover{border-color:#b9a99b;background:#faf6f1;transform:translateY(-2px)}.upload.ready{border-style:solid;border-color:#c8ded2;background:#f6fbf8}.upload input{position:absolute;width:1px;height:1px;opacity:0}.icon{width:42px;height:42px;display:grid;place-items:center;flex:0 0 auto;border-radius:13px;color:#fff;background:#2b211b;font-size:20px}.ready .icon{background:#247552}.upload>span:nth-child(3){min-width:0;flex:1}.upload strong,.upload small,.upload em{display:block}.upload strong{font-size:14px}.upload small{overflow:hidden;margin-top:5px;color:#8a8077;font-size:11px;text-overflow:ellipsis;white-space:nowrap}.upload em{margin-top:4px;color:#287653;font-size:10px;font-style:normal}.upload>b{color:#e96c28;font-size:11px}.file-actions{display:flex;justify-content:flex-end;gap:8px;margin:-8px 10px 0}.file-actions button{padding:6px 9px;border:0;color:#4a4039;background:transparent;font:800 10px Inter;cursor:pointer}.file-actions .remove{color:#b74735}
  `]
})
