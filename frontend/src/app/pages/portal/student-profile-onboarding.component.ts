...
@Component({
  ...
  styles: [`
    ...
    .student-head{height:64px;padding:0 28px;display:flex;align-items:center;border-bottom:1px solid var(--line)}.brand{display:flex;align-items:center;gap:9px;font-size:21px;font-weight:900}.brand span{width:29px;height:29px;display:grid;place-items:center;border-radius:8px;background:#102f45;color:#68d1b4}.head-actions{margin-left:auto;display:flex;align-items:center;gap:16px}.preview-pill{padding:6px 10px;border-radius:99px;background:#fff6db;color:#795b00;font-size:12px;font-weight:900}.head-actions button{border:0;background:none;color:#5f6d65;font-weight:800;cursor:pointer}
    ...
    .form-title{margin-bottom:20px}.form-title>span{color:var(--green);font-size:12px;font-weight:900;letter-spacing:.12em}.form-title h2{font-size:27px;margin:6px 0}.form-title p{color:var(--muted);margin:0;max-width:720px}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px 20px}.wide{grid-column:1/-1}label{display:flex;flex-direction:column;gap:7px;font-weight:800;font-size:14px}input,select,textarea{border:1px solid #cbd8d0;border-radius:9px;padding:12px;font:inherit;background:#fff}input:focus,select:focus,textarea:focus{outline:3px solid #dff2e8;border-color:var(--green)}textarea{min-height:92px;resize:vertical}.field-help{font-size:12px;color:var(--muted);font-weight:500}.check{flex-direction:row;align-items:center}.check input{width:18px;height:18px}
    .photo-builder{display:grid;grid-template-columns:150px 1fr;gap:24px;align-items:center;padding:18px;margin-bottom:22px;border:1px solid var(--line);border-radius:15px;background:#f8fbf9}.photo-ring{width:126px;height:126px;padding:5px;border-radius:50%;background:linear-gradient(135deg,#087a50,#7bd4aa);box-sizing:border-box}.photo-ring>div{width:100%;height:100%;display:grid;place-items:center;overflow:hidden;border:4px solid #fff;border-radius:50%;background:#dcebe3;color:#087a50;font-size:36px;font-weight:900}.photo-ring img{width:100%;height:100%;object-fit:cover}.photo-copy strong,.photo-copy small{display:block}.photo-copy strong{font-size:19px}.photo-copy small{margin:5px 0 12px;color:var(--muted);line-height:1.45}.photo-button{display:inline-flex;align-items:center;width:max-content;padding:10px 14px;border-radius:999px;background:#172019;color:#fff;cursor:pointer}.photo-button input{position:absolute;width:1px;height:1px;opacity:0}
    .choice-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.choice-grid.three-choice{grid-template-columns:repeat(3,1fr)}.choice-grid button{padding:24px;border:1px solid var(--line);border-radius:13px;background:#fff;text-align:left;cursor:pointer}.choice-grid button.selected{border-color:var(--green);background:var(--green-soft);box-shadow:0 0 0 2px #dff1e8}.choice-grid strong,.choice-grid small{display:block}.choice-grid strong{font-size:18px}.choice-grid small{margin-top:7px;color:var(--muted);line-height:1.45}.identity-title{margin-top:28px;padding-top:22px;border-top:1px solid var(--line)}
    ...
    .profile-preview{display:grid;grid-template-columns:260px 1fr;border:1px solid var(--line);border-radius:18px;overflow:hidden;box-shadow:0 18px 45px rgba(22,65,41,.08)}.profile-identity{padding:28px;text-align:center;background:linear-gradient(145deg,#123b2b,#087a50);color:#fff}.preview-avatar{width:120px;height:120px;margin:0 auto 15px;border:5px solid rgba(255,255,255,.9);border-radius:50%;overflow:hidden;background:#dcebe3;display:grid;place-items:center;color:#087a50;font-size:36px;font-weight:900}.preview-avatar img{width:100%;height:100%;object-fit:cover}.profile-identity h3{margin:0 0 5px;font-size:22px}.profile-identity p{margin:0;color:#c8ead9}.profile-details{padding:28px}.profile-details>span{font-size:12px;color:var(--green);font-weight:900;letter-spacing:.12em}.profile-details h3{font-size:26px;margin:7px 0}.profile-details p{color:var(--muted);line-height:1.55}.profile-facts{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:18px}.profile-facts div{padding:13px;background:#f3f8f5;border-radius:10px}.profile-facts small,.profile-facts strong{display:block}.profile-facts small{color:var(--muted);margin-bottom:4px}.tag-list{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px}.tag-list span{padding:7px 10px;border-radius:99px;background:var(--green-soft);color:var(--green);font-size:12px;font-weight:800}.privacy-note{padding:12px 14px;margin-top:16px;background:#f5f8f6;border-radius:9px;color:var(--muted);font-size:13px}
    .form-actions{display:flex;justify-content:space-between;margin-top:24px;padding-top:18px;border-top:1px solid var(--line)}.form-actions button{padding:11px 18px;border-radius:8px;font-weight:900;cursor:pointer}.secondary{background:#fff;border:1px solid #cbd7d0}.primary{margin-left:auto;background:var(--green);color:#fff;border:1px solid var(--green)}.tag-hint{color:var(--muted);font-size:12px}.success{padding:11px;border-radius:8px;background:#e9f7f0;color:#087a50}
