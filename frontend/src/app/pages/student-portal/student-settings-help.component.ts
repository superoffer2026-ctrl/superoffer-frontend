...
@Component({
  ...
  styles: [`
    ...
    .settings-help-heading>span,.settings-help-faq>div>span{color:#087a50;font-size:12px;font-weight:900;letter-spacing:.13em}
    h2{margin:7px 0;font-size:24px}p{color:#68766f}.settings-help-heading>p{margin:0 0 20px}
    ...
    .settings-help-actions strong{font-size:14px}.settings-help-actions small{margin-top:4px;overflow:hidden;color:#748078;font-size:12px;text-overflow:ellipsis;white-space:nowrap}
    .settings-help-actions>a>b{color:#087a50}
    .settings-help-faq{margin-top:24px}.settings-help-faq h3{margin:5px 0 15px;font-size:20px}
    details{padding:15px 0;border-top:1px solid #e4e8e5}
    summary{display:flex;align-items:center;justify-content:space-between;gap:20px;list-style:none;font-size:14px;font-weight:800;cursor:pointer}
    summary::-webkit-details-marker{display:none}summary b{color:#087a50}
    details p{max-width:800px;margin:10px 0 0;font-size:13px;line-height:1.65}
