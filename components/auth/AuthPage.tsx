...
import { clearAccessToken, writeLocal } from '@/lib/storage';
...
export function AuthPage({ mode, portal }: { mode: string; portal: PortalKey }) {
  ...
  const openPortal = async (
    ...
    clearAccessToken();
    writeLocal('superoffer_access_token', session.access_token);
  ...
  const whatsAppField = (
    <label className="full">
      ...
      <span className="phone-field">
        ...
        <input
          name="phone" type="tel" inputMode="numeric" autoComplete="tel-national"
