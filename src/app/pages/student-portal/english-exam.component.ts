    ...
    <section class="step-page">
      <form class="profile-form-card" [formGroup]="form" (ngSubmit)="saveAndContinue()">
        ...
        <div class="qualification-question" *ngIf="!attended">
          <h2>Have you taken or are preparing for an English proficiency exam? <span class="required-mark">*</span></h2>
          <div class="choice-grid">
            <button type="button" class="choice-card" (click)="onAttendedClick('Yes')">
              <span class="choice-icon">✓</span>
              <span><strong>Yes</strong><small>IELTS, TOEFL, PTE or DET</small></span>
            </button>
            <button type="button" class="choice-card" (click)="onAttendedClick('No')">
              <span class="choice-icon">–</span>
              <span><strong>No</strong><small>I haven't attempted any English exam yet</small></span>
            </button>
          </div>
...
export class EnglishExamComponent implements OnInit {
  ...
  get examsArray(): FormArray { return this.form.get('english') as FormArray; }
