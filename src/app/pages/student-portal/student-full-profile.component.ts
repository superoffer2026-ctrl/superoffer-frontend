...
export class StudentFullProfileComponent {
  sections = [
    ...
    { eyebrow:'FINANCIAL',title:'Financial information',route:'/student/financial-information',items:[{label:'Household income',key:'annualHouseholdIncome',fallback:'18,00,000 annually'},{label:'Funding source',key:'fundingSource',fallback:'Self-Funded'},{label:'Employment category',key:'employmentCategory',fallback:'Salaried'}]},
    { eyebrow:'PROFILE',title:'Skills and achievements',route:'/student/projects',items:[{label:'Skills',key:'technicalSkills',fallback:'Python, SQL, Machine Learning'},{label:'Languages',key:'languages',fallback:'English, Hindi'},{label:'Featured project',key:'projectTitle',fallback:'Student success prediction model'}]}
  ];
