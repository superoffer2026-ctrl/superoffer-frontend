...
@Component({
  ...
  styles: [`
    ...
    .scard-avatar{position:relative;flex:0 0 auto;width:84px;height:84px;display:grid;place-items:center;overflow:hidden;border-radius:24px;background:rgba(255,255,255,.12);border:2px solid rgba(255,255,255,.25);color:#fff;font-size:28px;font-weight:900;z-index:1}
    .scard-avatar img{width:100%;height:100%;object-fit:cover}
    .scard-verified{position:absolute;right:-6px;bottom:-6px;width:26px;height:26px;display:grid;place-items:center;border-radius:50%;background:#67d0b2;color:#0d2d42;font-size:15px;font-weight:900;border:3px solid #0d2d42}
    .scard-identity{position:relative;flex:1;min-width:0;z-index:1}
    .scard-kicker{display:block;margin-bottom:8px;font-size:12px;font-weight:900;letter-spacing:.16em;color:#8ed9c2}
    .scard-identity h1{margin:0 0 14px;font-family:"Libre Franklin",sans-serif;font-size:clamp(26px,3vw,34px);letter-spacing:-.03em}
    .scard-summary-row{display:flex;flex-wrap:wrap;gap:8px}
    .scard-pill{padding:7px 13px;border-radius:999px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.16);font-size:13px;font-weight:700;color:#d7e6df}
    ...
    .scard-ring span{width:50px;height:50px;display:grid;place-items:center;border-radius:50%;background:#0d2d42;color:#fff;font-size:15px;font-weight:900}
    .scard-completion small{font-size:11px;font-weight:800;letter-spacing:.05em;color:#a9d9c8}
