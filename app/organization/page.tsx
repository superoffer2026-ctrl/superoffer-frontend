...
import { PortalLanding, type PortalContent } from '@/components/shared/PortalLanding';

export const metadata: Metadata = { title: 'Organizations | SuperOffer' };

const content: PortalContent = {
  key: 'organization',
  eyebrow: 'SuperOffer for organizations',
  title: 'Reach the right students, as a university or a bank.',
  intro:
    'Discover qualified, verified students, manage your pipeline, and send transparent admission or loan offers from one verified organization workspace.',
  primary: 'Register organization',
  secondary: 'Learn more',
  stats: [
    { value: 'AI', label: 'student matching' },
    { value: '100%', label: 'verified organisation access' },
    { value: 'One', label: 'workspace for every offer' }
  ],
  ...
  process: [
    'Register your organization and authorised contact',
    'Choose your organization type — university or bank',
    'Submit accreditation or licence information',
    'Super Admin reviews the organisation',
    'Verified organization dashboard is activated'
  ],
  requirements: [
    'Organization legal name and type',
    'Accreditation or lending licence details',
    'Government registration number',
    'Official organization email and domain',
...
export default function OrganizationPage() {
  return <PortalLanding content={content} />;
}
