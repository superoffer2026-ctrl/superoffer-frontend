...
export const metadata: Metadata = { title: 'Students | SuperOffer' };

const content: PortalContent = {
  key: 'student',
  eyebrow: 'Your opportunities, organised',
  title: 'Build one profile. Receive the right offers.',
  intro:
    'Stop repeating the same search across hundreds of sites. Keep academics, test scores, preferences, and verified documents together, then review university opportunities from one private workspace.',
  primary: 'Create student account',
  secondary: 'See student services',
  stats: [
    { value: 'One', label: 'verified student profile' },
    { value: '3', label: 'offer categories to compare' },
    { value: '14 days', label: 'standard invitation window' }
  ],
  ...
  process: [
    'Register your free student account',
    'Complete academics, preferences, tests, and documents',
    'Turn visibility on when your profile is ready',
    'Review and respond to relevant invitations'
  ],
  faqs: [
